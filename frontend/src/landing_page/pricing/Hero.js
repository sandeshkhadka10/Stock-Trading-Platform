...
function Hero() {
  return (
    <div className="container">
      <div className="row text-center mt-5 border-bottom p-4 p-md-5">
        <h1>Pricing</h1>
        <h3 className="text-muted fs-6 fs-md-5 mt-3">
          Free equity investments and flat ₹20 traday and F&O trades
        </h3>
      </div>
      <div className="row mt-4 mt-md-5 p-3 p-md-5">
        ...
        <div className="col-12 col-md-4 p-3 p-md-4 text-center">
          <img src="media/images/intradayTrades.svg" alt="Intraday and F&O trades" className="img-fluid mb-3" />
